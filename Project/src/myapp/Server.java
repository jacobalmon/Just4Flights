...
public class Server {
    ...
    /**
     * The main method initializes the server by loading the JDBC driver and creating a server socket
     * to listen for client connections on port 8080.
     * It continuously accepts client connections and handles each client request in a separate thread.
     * 
     ...
     * Reads the request type from the client, processes the request, and sends back a response.
     *
    ...
    /**
     * Executes a given SQL query and returns the results as a formatted string.
     * 
     * @param query The SQL query to be executed.
     * @return A string containing the formatted results of the query.
     */
